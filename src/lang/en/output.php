...
return [
    'connection_error' => 'Connection error, please check your db configuration in .env, and any overrides in config/db-shell.',
    ...
    'startup' => 'Welcome to db:shell.',
    'startup_exit' => 'Type "exit" to exit.',
    'update_response_summary' => 'Rows matched: :matchCount  Changed: :changedCount  Warnings: :warningCount',
    'vertical' => [
